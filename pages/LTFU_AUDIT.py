...
if df is not None:
    ...
    if 'Name of health facility:' in df.columns:
    ...
    reason_col = 'What was the reason of Missing an Appointment/LTFU (interrupting treatment) as per the last tracing attempt'
    ...
    status_col = 'Client status on day of audit'
